              ...
              >
                {[1, 2, 3, 4, 5, 6].map((i) => (
                  <motion.div
                    ...
                    className="bg-[var(--bg-card)] rounded-2xl p-4 border border-[var(--border-color)] flex flex-col items-center justify-center gap-3 aspect-square cursor-pointer"
                  >
                    ...
                    <p className="text-[10px] font-bold text-[var(--text-muted)] truncate w-full text-center">
                      Node_{i}
                    </p>
                  </motion.div>
                ))}
