  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-[var(--accent-orange)] text-white rounded-3xl p-8 shadow-lg flex flex-col gap-4"
      >
      ...
      >
        ...
        <div className="mt-6 text-center">
          ...
          <strong
            className={`text-[10px] uppercase ${anomalies.includes("FLAG") ? "text-red-500" : "text-[var(--accent-orange)]"}`}
          >
            {anomalies}
          </strong>
        </div>
